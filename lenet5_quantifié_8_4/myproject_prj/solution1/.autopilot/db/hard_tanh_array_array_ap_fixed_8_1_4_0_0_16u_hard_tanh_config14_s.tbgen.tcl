set moduleName hard_tanh_array_array_ap_fixed_8_1_4_0_0_16u_hard_tanh_config14_s
set isTopModule 0
...
set C_modelName {hard_tanh<array,array<ap_fixed<8,1,4,0,0>,16u>,hard_tanh_config14>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer13_out int 544 regular {fifo 0 volatile }  }
	{ layer14_out int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 544, "direction" : "READONLY"} , 
 	{ "Name" : "layer14_out", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer13_out_dout sc_in sc_lv 544 signal 0 } 
	...
	{ layer14_out_din sc_out sc_lv 128 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer13_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":544, "type": "signal", "bundle":{"name": "layer13_out", "role": "dout" }} , 
 	...
 	{ "name": "layer14_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "layer14_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer13_out { ap_fifo {  { layer13_out_dout fifo_data_in 0 544 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer13_out_fifo_cap fifo_update 0 2 }  { layer13_out_empty_n fifo_status 0 1 }  { layer13_out_read fifo_port_we 1 1 } } }
	layer14_out { ap_fifo {  { layer14_out_din fifo_data_in 1 128 }  { layer14_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer14_out_fifo_cap fifo_update 0 2 }  { layer14_out_full_n fifo_status 0 1 }  { layer14_out_write fifo_port_we 1 1 } } }
}
