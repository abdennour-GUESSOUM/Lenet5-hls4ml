set moduleName hard_tanh_array_array_ap_fixed_8_1_4_0_0_16u_hard_tanh_config18_s
set isTopModule 0
...
set C_modelName {hard_tanh<array,array<ap_fixed<8,1,4,0,0>,16u>,hard_tanh_config18>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer17_out int 480 regular {fifo 0 volatile }  }
	{ layer18_out int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer17_out", "interface" : "fifo", "bitwidth" : 480, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer17_out_dout sc_in sc_lv 480 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer17_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":480, "type": "signal", "bundle":{"name": "layer17_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer17_out { ap_fifo {  { layer17_out_dout fifo_data_in 0 480 }  { layer17_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer17_out_fifo_cap fifo_update 0 2 }  { layer17_out_empty_n fifo_status 0 1 }  { layer17_out_read fifo_port_we 1 1 } } }
	layer18_out { ap_fifo {  { layer18_out_din fifo_data_in 1 128 }  { layer18_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer18_out_fifo_cap fifo_update 0 2 }  { layer18_out_full_n fifo_status 0 1 }  { layer18_out_write fifo_port_we 1 1 } } }
}
