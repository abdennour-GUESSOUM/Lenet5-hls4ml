set moduleName hard_tanh_array_array_ap_fixed_8_1_4_0_0_6u_hard_tanh_config4_s
set isTopModule 0
...
set C_modelName {hard_tanh<array,array<ap_fixed<8,1,4,0,0>,6u>,hard_tanh_config4>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer2_out int 132 regular {fifo 0 volatile }  }
	{ layer4_out int 48 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer2_out", "interface" : "fifo", "bitwidth" : 132, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer2_out_dout sc_in sc_lv 132 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":132, "type": "signal", "bundle":{"name": "layer2_out", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer2_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "576", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer2_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer4_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "576", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer2_out { ap_fifo {  { layer2_out_dout fifo_data_in 0 132 }  { layer2_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer2_out_fifo_cap fifo_update 0 11 }  { layer2_out_empty_n fifo_status 0 1 }  { layer2_out_read fifo_port_we 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_data_in 1 48 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer4_out_fifo_cap fifo_update 0 11 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_port_we 1 1 } } }
}
