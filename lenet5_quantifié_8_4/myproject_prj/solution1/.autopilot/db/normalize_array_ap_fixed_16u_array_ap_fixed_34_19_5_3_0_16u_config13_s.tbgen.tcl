set moduleName normalize_array_ap_fixed_16u_array_ap_fixed_34_19_5_3_0_16u_config13_s
set isTopModule 0
...
set C_modelName {normalize<array<ap_fixed,16u>,array<ap_fixed<34,19,5,3,0>,16u>,config13>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer11_out int 400 regular {fifo 0 volatile }  }
	{ layer13_out int 544 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer11_out", "interface" : "fifo", "bitwidth" : 400, "direction" : "READONLY"} , 
 	{ "Name" : "layer13_out", "interface" : "fifo", "bitwidth" : 544, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer11_out_dout sc_in sc_lv 400 signal 0 } 
	...
	{ layer13_out_din sc_out sc_lv 544 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer11_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":400, "type": "signal", "bundle":{"name": "layer11_out", "role": "dout" }} , 
 	...
 	{ "name": "layer13_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":544, "type": "signal", "bundle":{"name": "layer13_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer11_out { ap_fifo {  { layer11_out_dout fifo_data_in 0 400 }  { layer11_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer11_out_fifo_cap fifo_update 0 2 }  { layer11_out_empty_n fifo_status 0 1 }  { layer11_out_read fifo_port_we 1 1 } } }
	layer13_out { ap_fifo {  { layer13_out_din fifo_data_in 1 544 }  { layer13_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer13_out_fifo_cap fifo_update 0 2 }  { layer13_out_full_n fifo_status 0 1 }  { layer13_out_write fifo_port_we 1 1 } } }
}
