...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_layer_TVALID { I 1 bit } input_layer_TDATA { I 8 vector } input_layer_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { layer2_out_din { O 132 vector } layer2_out_num_data_valid { I 11 vector } layer2_out_fifo_cap { I 11 vector } layer2_out_full_n { I 1 bit } layer2_out_write { O 1 bit } } \
} "
}
